...
export const metadata: Metadata = {
  title: "Ahmed & Ashrqat | Wedding Invitation",
  description:
    "Join us to celebrate the wedding of Ahmed Qandeel and Ashrqat El-Bidwehy. Friday, 9 October 2026, 8 PM at Tiba Rose Hotel.",
